#ifndef __MTS_SVCER_SYSCALL_H__
#define __MTS_SVCER_SYSCALL_H__
...
public:
    SvcerSyscall() = delete;
    SvcerSyscall(const SvcerSyscall&) = delete;
    SvcerSyscall& operator=(const SvcerSyscall&) = delete;
...
private:
    ...
    static intptr_t SandboxSyscallRaw(int nr, const intptr_t* args, intptr_t* err_stat);
#endif  // defined(__mips__)
};

#endif // __MTS_SVCER_SYSCALL_H__
