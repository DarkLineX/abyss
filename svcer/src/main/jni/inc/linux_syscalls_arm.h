...
// source code: https://chromium.googlesource.com/chromiumos/docs/+/master/constants/syscalls.md#arm-32_bit_EABI

#ifndef __ARM_LINUX_SYSCALLS_H__
#define __ARM_LINUX_SYSCALLS_H__
...
#if !defined(__NR_fstatat)// __NR_fstatat64
#define __NR_fstatat (__NR_SYSCALL_BASE+327)
#endif
...
#endif  // __ARM_LINUX_SYSCALLS_H__
